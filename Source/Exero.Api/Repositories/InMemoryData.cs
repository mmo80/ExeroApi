...
namespace Exero.Api.Repositories
{
    public static class InMemoryData
    {
        ...
        public static IList<ExerciseCategory> Categories => new List<ExerciseCategory>()
        {
            new ExerciseCategory() { Id = Guid.Parse("b6a521ef-a47b-4966-ae02-cb889e8f2cc3"), Name = "Biceps", User = FirstUser},
            new ExerciseCategory() { Id = Guid.Parse("d064b338-55e3-4d5d-a33a-10ae6711894a"), Name = "Chest" , User = FirstUser}
        };
